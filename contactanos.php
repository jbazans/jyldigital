...
<body onload="animaciones()">
	...
	<div class="contactanos-cuerpo-main">
		<div class="contenedor-img">
			...
			<div class="contenido-img-titulo">
				<img src="img/contactanos-titulo.png" class="img-con-titulo">
			</div>			
		</div>
	...
	<div class="contactanos-cuerpo-main" id="form-contacto">
		<div class="contenedor-img">
			...
			<div class="form-contactanos">
				...
				<div class="lado-form">
					<div class="fila-imagen">
						<img src="img/contactanos-cotizacion.png" class="img-cotizacion">
					</div>
